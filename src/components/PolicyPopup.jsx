...
const PolicyPopup = (props) => {
    ...
    return (
        <div>
            <div class="daisy-card-popup w-full h-full absolute top-0 left-0 flex flex-col items-center justify-center p-8 bg-gray-800 bg-opacity-75 z-50">
                ...
                <div class="w-full max-w-md bg-white shadow-lg rounded-lg p-8">
                    ...
                    <button onClick={props.onClose} class="w-full py-2 px-4 bg-red-500 text-white rounded-full hover:bg-red-700 focus:outline-none focus:shadow-outline-red active:bg-red-800">
                        Close Window
                    </button>
                </div>
            </div>
